...
export function AppSidebar() {
  ...
  return (
    <aside
      ...
      className={cn(
        "fixed left-0 top-0 bottom-0 z-50 glass-sidebar flex flex-col transition-all duration-300 ease-in-out",
    ...
    >
      ...
      <div suppressHydrationWarning className="mt-auto shrink-0 border-t border-sidebar-border/30 pt-2 pb-2">
        <SidebarFooter />
      </div>
    </aside>
  )
