...
export default function CoursesPage() {
  ...
  const handleLearnNow = (courseId: string) => {
      // Navigate to generic course viewer
            ...
            return (
              <Card key={course.id} className="overflow-hidden h-full flex flex-col">
                <CardContent className="p-6 flex flex-col flex-1">
                  ...
                  {/* Free Content Info - using optional property if exists */}
                  {!hasAccess && course.freeContent && (
                  ...
                  {hasAccess ? (
                    ...
                    <div className="space-y-3">
                      ...
                      <Button
                        ...
                        onClick={() => {
                            // Generic free content logic or route
                            router.push(`/course-viewer?courseId=${course.id}&free=true`);
                        }}
                      >
                        Try Free Content →
                      </Button>
