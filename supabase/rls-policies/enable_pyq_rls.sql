...
DROP POLICY IF EXISTS "Allow public read access to pyqs" ON pyqs;
...
SELECT * FROM pg_policies WHERE schemaname = 'public' AND tablename IN ('pyqs', 'pyq_subject_topic', 'pyq_user_performance');
