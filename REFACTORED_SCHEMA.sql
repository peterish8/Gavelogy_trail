-- ============================================
-- GAVALOGY REFACTORED DATABASE SCHEMA
-- Production-ready schema with improved data types and normalization
-- ============================================
...
CREATE TYPE confidence_level AS ENUM ('confident', 'guess', 'fluke');
CREATE TYPE source_type_enum AS ENUM ('quiz', 'mock');
